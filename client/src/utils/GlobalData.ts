...
export const globalData = new Map<string, Common.globalDataType>([
  ...
  [
    "asia2023",
    {
      ...
      postEventHighlightVideoURL: "https://www.youtube.com/watch?v=tiiVjMlTuqk",
  ...
  [
    "jp2023",
    {
      ...
      postEventGalleryImageList: [
        ...
        `${S3_URL}/upload/jp/landing/NSSJ_Highlight_08.jpg`,
        `${S3_URL}/upload/jp/landing/NSSJ_Highlight_09.jpg`,
        `${S3_URL}/upload/jp/landing/NSSJ_Highlight_10.jpg`,
        `${S3_URL}/upload/jp/landing/NSSJ_Highlight_11.jpg`,
        `${S3_URL}/upload/jp/landing/NSSJ_Highlight_12.jpg`,
        `${S3_URL}/upload/jp/landing/NSSJ_Highlight_13.jpg`,
      ],
    },
  ],
  [
